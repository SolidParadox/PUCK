...
public class DataPlotter : MonoBehaviour {
  ...
  public Color marginColor = Color.red;

  public      float   lineHigh;
  public      float   lineLow;

  public      Vector2 spacing = new Vector2( 0.01f, 0.1f );
  ...
  public virtual void LateUpdate () {
    ...
    DrawScaled ( new Vector2 ( 0, lineHigh ), new Vector2 ( mx, lineHigh ), marginColor );
    DrawScaled ( new Vector2 ( 0, lineLow ), new Vector2 ( mx, lineLow ), marginColor );
  }
}
