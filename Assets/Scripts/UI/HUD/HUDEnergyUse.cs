...
public class HUDEnergyUse : MonoBehaviour {
  ...
  private void LateUpdate () {
    ...
    drawPos.value = Mathf.Lerp ( drawPos.value, energyCore.currentDraw < 0 ? -energyCore.currentDraw : 0, Time.deltaTime * lerpStrength );
    drawNeg.value = Mathf.Lerp ( drawNeg.value, energyCore.currentDraw > 0 ? energyCore.currentDraw : 0, Time.deltaTime * lerpStrength );
